...
class HNSW(object):
    ...
    def get_neighbors(self, point_id, level):
        return _swigfaiss.HNSW_get_neighbors(self, point_id, level)

    def get_all_neighbors(self, point_id):
        return _swigfaiss.HNSW_get_all_neighbors(self, point_id)
